...
<body>
      ...
      <div class="Footer">
          <div class="row">
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 visible-lg visible-md visible-sm visible-xs text-center">
                  <h1 class="text-center text-uppercase"> FOLLOW US</h1>
