...
<body>
  <div class="Container">
      <div class="Header">
              <img src="../image/ima.png" width="100%" height="500px">
          <div class="Logo">
              <div class ="SpanLogo" >
         ...
         <div class="Menu">
             <ul>
                 <li><a style="margin-left:70px">About Us</a></li>
                 <li><a>Product& Services</a></li>
                 <li><a>Quote Request</a></li>
                 <li><a style="margin-left: -15px">Contact Us</a></li>
             </ul>
         </div>
      ...
      <div class="Body">
            ...
            <p>About<span>yellowsea Logistic</span></p>
            <p>
            ...
            <div class="Image">
              <img src="../image/ima.png" style="width:100%; height:300px;">
            ...
            <h1><p>PRODUCT & SERVICE</p><hr width="15%" style="background-color: darkorange"></h1>

            <div class="IntermodalService">
                <p><h2>Intermodal Service</h2></p>
                ...
                </p><hr style="background-color: darkorange">
            </div>
            ...
            <div class="FrieghtImage">
                 <img src="../image/404.png" width="95%" height="160px" style="margin-left: -20px;">
            </div>

            <div class="CustomHouseBrokerage">
                <p><h2>Custom House Brokerage</h2></p>
            ...
            <div class="WarehousingImage">
                    ...
                    <img src="../image/404.png" width="95%" height="160px" style="margin-left:-20px; margin-top: 10px;">
            </div>

            <div class="ImagenearFooter">
                <img src="../image/ima1.png" width="100%" height="250px">
      ...
      <div class="Footer">
          ...
          <a href="#" class="fa fa-facebook" style="margin-left:400px;"></a>
          ...
          <div class="FooterItem">
              <a style="margin-left:300px">About Us </a>
              <a style="margin-left:-50px">Quote Request</a>
              <a>Products & Service</a>
              <a>Contact Us</a>
              <p>@2017 Yellow Sea Logistics.All right reserved Designed by Flexitech</p>
          </div>
      </div>
